...
function content_recommended_plugins_array($plugins){
		...
		$plugins[] = array(
					'name'     => esc_html__('Seo Optimized Images', 'content'),
		            'slug'     => 'seo-optimized-images',
		            'desc'     => esc_html__('It is recommended that you install & activate the Seo Optimized Images plugin to dynamically insert SEO Friendly alt attributes and title attributes to your Images.', 'content'),
				);
