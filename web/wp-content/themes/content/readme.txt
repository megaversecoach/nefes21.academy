...
Content WordPress Theme is the child theme of SpicePress Theme, Copyright (C) 2018-2023, SpiceThemes
Content WordPress Theme is distributed under the terms of the GNU GPL

== Changelog ==

= 1.9.4 ==
1. Updated correct url for respective link text.

= 1.9.3 ==
1. Recommended the SEO optimized images plugin on the options page.
