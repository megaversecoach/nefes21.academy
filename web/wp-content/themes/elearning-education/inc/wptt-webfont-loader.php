...
if ( ! class_exists( 'Elearning_Education_WPTT_WebFont_Loader' ) ) {
	...
	class Elearning_Education_WPTT_WebFont_Loader {
		 ...
		 * @access public
		 * @since 1.0.0
		 * @return array Returns an array of remote URLs and their local elearning_education_counterparts.
		 */
...
if ( ! function_exists( 'wptt_get_web_elearning_education_font_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function wptt_get_web_elearning_education_font_url( $url, $format = 'woff2' ) {
		$font = new Elearning_Education_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
