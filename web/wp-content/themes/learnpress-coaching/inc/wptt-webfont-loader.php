...
if ( ! class_exists( 'Learnpress_Coaching_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Learnpress_Coaching_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Learnpress_Coaching_WPTT_WebFont_Loader( $url );
