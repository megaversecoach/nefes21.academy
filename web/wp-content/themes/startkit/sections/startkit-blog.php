						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post blog-style-2'); ?>>
							<div class="post-thumbnail">
								<div class="post-overlayed">
									...
									$after = '';
									if(!empty($tag_list)) { ?>                                      
									<div class="tags tags-cat"><a href="<?php esc_url(get_permalink()); ?>"><i class="fa fa-hand-o-right"></i> <?php the_tags( $before, $seperator, $after ); ?></a></div>
									<?php } ?>                                  
									<?php } ?>
									<a  href="<?php esc_url(get_permalink()); ?>" class="img-responsive center-block home-blogs" ><?php the_post_thumbnail(); ?></a>
								</div>
							</div>
							...
							<div class="post-footer">
								...
								<div class="post-cat">
									...
									if(!empty($cat_list)) { ?>                                      
									<div class="post-category"><i class="fa fa-folder-open" aria-hidden="true"></i> <a href="<?php esc_url(get_permalink()); ?>"> <?php the_category(', '); ?></a></div>
									<?php } ?>
								</div>
							</div>
						</article>
