...
if ( ! defined( 'ONLINE_TUTOR_URL' ) ) {
    define( 'ONLINE_TUTOR_URL', esc_url( 'https://www.themagnifico.net/products/tutor-university-wordpress-theme', 'tutor-academy') );
}
...
function tutor_academy_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('tutor_academy_search_setting', array(
        'default' => false,
        'sanitize_callback' => 'online_tutor_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'tutor_academy_search_setting',array(
        'label'          => __( 'Enable Header Search', 'tutor-academy' ),
        'section'        => 'online_tutor_top_header',
        'settings'       => 'tutor_academy_search_setting',
        'type'           => 'checkbox',
    )));
}
...
define('ONLINE_TUTOR_LIVE_DEMO',__('https://demo.themagnifico.net/tutor-academy/','tutor-academy'));
}
if ( ! defined( 'ONLINE_TUTOR_GET_PREMIUM_PRO' ) ) {
define('ONLINE_TUTOR_GET_PREMIUM_PRO',__('https://www.themagnifico.net/products/tutor-university-wordpress-theme','tutor-academy'));
}
if ( ! defined( 'ONLINE_TUTOR_PRO_DOC' ) ) {
define('ONLINE_TUTOR_PRO_DOC',__('https://demo.themagnifico.net/eard/wathiqa/tutor-academy-pro-doc/','tutor-academy'));
}
if ( ! defined( 'ONLINE_TUTOR_FREE_DOC' ) ) {
define('ONLINE_TUTOR_FREE_DOC',__('https://demo.themagnifico.net/eard/wathiqa/tutor-academy-free-doc/','tutor-academy'));
}